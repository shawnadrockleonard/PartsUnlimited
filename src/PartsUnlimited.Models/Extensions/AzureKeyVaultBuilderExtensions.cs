...
namespace PartsUnlimited.Models.Extensions
{
    public static class AzureKeyVaultBuilderExtensions
    {
        ...
        private const string AzureKeyVaultClientId = "ClientId";
        private const string AzureKeyVaultClientKey = "ClientSecret";
        ...
        public static IConfigurationBuilder AddAzureKeyVaultIfAvailable(this IConfigurationBuilder builder)
        {
            ...
            string clientId = keyVaultConfiguration[AzureKeyVaultClientId];
            ...
            else
            {
                ...
                builder.AddAzureKeyVault(vaultUrl, clientId, keyVaultConfiguration[AzureKeyVaultClientKey]);
            }
